...
<div class="header">
  ...
  <p>All the Available information about Customer's Booking</p>
 </div>
<div class="row">
  <div class="column">
<?php
error_reporting(0);
   include "connection.php";
    $result=mysqli_query($conn,"select * from customer_master c,booking b,package p where c.User_ID=b.User_id and b.PackageID=p.Package_ID");
